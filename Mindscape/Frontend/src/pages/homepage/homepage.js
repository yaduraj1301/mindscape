        ...
        <div className={styles.homepageContainer}>
            <header>
                <div className={styles.logoContainer}>
                    ...
                    <div className={styles.headerText}>
                        <h4 className={styles.text}>Mindscape</h4>
            ...
            <main style={{ minHeight: "100vh" }}>
                <section className={styles.leftSection}>
                    <h1>
                        Your Mental Health Companion. <br /> Anytime, Anywhere.
                    </h1>
                    <div
            ...
            >
                ...
                <div className={`text-center text-lg ${styles.lato}`}>
                    Welcome to our mental health chat assistant platform, Your Mental Health Companion. Anytime, Anywhere.
                    Get personalized support for your mental well-being with our AI-powered chatbot,
                    rooted in evidence-based therapies. We offer a supportive community where our empathetic
                    AI actively listens, provides encouragement, and connects you with valuable resources.
                    Together, we prioritize your well-being and foster open dialogue around mental health.
                    You're not alone; we stand with you on your journey. Let's build a space where
            ...
            <footer className={styles.footer}>
                <div className="m-auto h-full" style={{ maxWidth: "1320px" }}>
                    <div className="grid grid-cols-2 h-5/6">
                        ...
                        <div className="flex flex-col justify-center items-center gap-3 text-lg">
                            <a
                                href="https://github.com/ashiqrahman10/mindscape"
                                target="_blank"
                    ...
                    <div className="text-center">2024 Copyright © | Mindscape | All rights reserved</div>
                </div>
            </footer>
