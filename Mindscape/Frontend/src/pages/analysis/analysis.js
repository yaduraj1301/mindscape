    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                let response = await fetch("http://20.197.0.69:3000/chart", {
                    method: "POST",
                    body: bodyContent,
                    headers: headersList
                });
                        ...
                        <div className={styles.analList}>
                            {analysisHist.map((rep, i) => (
                                <div
                                    ...
                                    className={`${styles.analItem} ${analysisHist[i]?.new ? styles.newAnalItem : ""
                                        }`}
                                >
                                    <span></span>
